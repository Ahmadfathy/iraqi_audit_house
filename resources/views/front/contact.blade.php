    ...
    <div class="container py-5-5">
        <div class="row align-items-center">
            <div class="col-md-4 mb-4 mb-md-0">
                <h3 class="font-weight-bold text-color-light line-height-1 text-4 ls-0 mb-1 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="200">تحدث إلي مختصينا</h3>
                <h2 class="text-color-light font-weight-bold text-8 ls-0 mb-3 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400">في إنتظار تواصلك!</h2>
            ...
            <div class="col-md-8 divider-left-border custom-mobile-remove-divider-left-border border-color-light-4">
                <div class="ps-md-4 ps-lg-4 py-md-5 ms-md-4">
                    ...
                    <div class="d-flex align-items-center my-5-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="1100">
                        ...
                        <a href="mailto:Info@IraqiAuditHouse.com" class="text-4-5 font-weight-bold text-color-light opacity-hover-8 text-decoration-none ps-3-5">Info@IraqiAuditHouse.com</a>
                    </div>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-7 col-lg-5">
                <h3 class="font-weight-bold text-color-light line-height-1 text-4 ls-0 mb-1">اطلب مكالمة</h3>
                <h2 class="text-color-light font-weight-bold text-8 ls-0 mb-3">و سنتواصل بك لاحقاً</h2>
