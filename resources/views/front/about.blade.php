...
<div class="container py-5-5 my-5-5">
    <div class="row justify-content-center">
        ...
        <div class="col-sm-9 col-md-7 col-lg-4 offset-lg-1">
            <img src="img/about_1.jpg" class="img-fluid appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="800" alt="Building image showing the company" />
        </div>
    </div>
</div>
